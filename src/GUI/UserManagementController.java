...
public class UserManagementController implements Initializable {
 ...
 private Parent root;   
  ...
  stage.show();
    ...
    @FXML
    private void Management(MouseEvent event) {
    }

    @FXML
    private void block(MouseEvent event) throws IOException {
         root = FXMLLoader.load(getClass().getResource("BanUserGui.fxml"));
  stage = (Stage)((Node)event.getSource()).getScene().getWindow();
  scene = new Scene(root);
  stage.setScene(scene);
  stage.show();
